  ...
  return (
    <>
      {isDeleting && (<Modal onClose={handleStopDelete}>
        ...
        {isError && <ErrorBlock title={`Failed to delete event`} message={deleteError?.info.message || 'Failed to delete event, please try again later'} />}
      </Modal >)}
      <Outlet />
      <Header>
      ...
      {isError && <ErrorBlock
        title='Failed to event details'
        message='Please try again later'
      />}
      {isPending && <p>Event data loading...</p>}
      {
        data &&
